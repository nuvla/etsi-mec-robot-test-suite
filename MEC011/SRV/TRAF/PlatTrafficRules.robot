...
TC_MEC_MEC011_SRV_TRAF_001_OK
    ...
    ...
    ...    Reference
    ...    ETSI GS MEC 011 3.3.1, clause 5.2.7,
    ...    ETSI GS MEC 011 3.3.1, clause 7.1.2.2,
    ...    ETSI GS MEC 011 3.3.1, clause 7.2.7.3.1
...
TC_MEC_MEC011_SRV_TRAF_001_NF
    ...
    ...
    ...    Reference  ETSI GS MEC 011 3.3.1, clause 5.2.7,
    ...    ETSI GS MEC 011 3.3.1, clause 7.1.2.2,
    ...    ETSI GS MEC 011 3.3.1, clause 7.2.7.3.1
...
TC_MEC_MEC011_SRV_TRAF_002_OK
    ...
    ...    Reference  ETSI GS MEC 011 3.3.1, clause 5.2.7,
    ...    ETSI GS MEC 011 3.3.1, clause 7.1.2.2,
    ...    ETSI GS MEC 011 3.3.1, clause 7.2.8.3.1
    [Tags]    PIC_MEC_PLAT    PIC_SERVICES
    [Setup]  Create a new MEC application   AppInfo
...
TC_MEC_MEC011_SRV_TRAF_003_OK
    ...
    ...    Reference  ETSI GS MEC 011 3.3.1, clause 5.2.7,
    ...    ETSI GS MEC 011 3.3.1, clause 7.1.2.2,
    ...    ETSI GS MEC 011 3.3.1, clause 7.2.8.3.2
    [Tags]    PIC_MEC_PLAT    PIC_SERVICES
    [Setup]  Create a new MEC application   AppInfo
